...
@section('title-content')
    <i class="fas fa-box-open mr-2"></i> <!-- Perbaikan nama icon -->
    Produk
@endsection
@section('content')
    <div class="row">
            ...
            <form method="POST" class="card card-orange card-outline"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <x-textarea name="nama_produk" :value="$produk->nama_produk" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <x-input name="kategori_id" :options="$kategoris" :value="$produk->kategori_id" />
                    </div>
                </div>
